...
3. Add your network to Metamask using [Network Information](/build/network) or you can add `Mint Sepolia Testnet` from [ChainList](https://chainlist.org/chain/1687)
