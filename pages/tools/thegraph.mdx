...
![CLI commands](/public/assets/thegraph-cli.png)
...
![cli sample](/public/assets/thegraph-init.png)
...
Authenticate within the CLI, build and deploy your Subgraph to the Studio.You can copy these commands directly from your subgraph's page in Studio to include your specific deploy key and subgraph slug:
