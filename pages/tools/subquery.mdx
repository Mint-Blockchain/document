...
SubQuery is among the leading blockchain data indexers, providing developers with fast, flexible, universal, open-source, and decentralized APIs for web3 projects. SubQuery SDK allows developers to get rich indexed data and build intuitive and immersive decentralised applications in a faster and more efficient way.
...
- [Mintchain Starter Project](https://github.com/subquery/ethereum-subql-starter/tree/main/Mint/mint-starter)

For technical questions and support reach out to us `start@subquery.network`

## Running and Hosting your Mintchain SubQuery APIs
