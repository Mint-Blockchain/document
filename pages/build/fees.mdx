...
For additional details about fee calculation on Mint, please refer to the [op-stack developer documentation](https://docs.optimism.io/stack/transactions/fees).